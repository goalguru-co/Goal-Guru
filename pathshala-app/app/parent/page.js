          ...
          <>
              ...
              <div className="flex gap-2 mt-6">
                {children.map((c) => (
                  <button
                    ...
                    className={`text-sm px-4 py-2 rounded-lg border ${selectedChild?.id === c.id ? "bg-clay text-paper border-clay" : "border-[#D9D2C0]"}`}
                  >
                    {c.full_name}
                  </button>
                ))}
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-6">
              ...
              <div className="card p-5">
                ...
                {submissions.map((s) => (
                  <div key={s.id} className="flex justify-between text-sm py-2 border-b border-[#EAE3D3] last:border-0">
              ...
              <div className="card p-5">
                ...
                {fees.map((f) => (
                  <div key={f.id} className="flex justify-between text-sm py-2 border-b border-[#EAE3D3] last:border-0">
              ...
              <div className="card p-5">
                ...
                {remarks.map((r) => (
                  <p key={r.id} className="text-sm py-2 border-b border-[#EAE3D3] last:border-0">{r.remark}</p>
                ))}
              </div>
            </div>
